...
export default function PageHeader({ title, theme = 'dark' }: PageHeaderProps) {
  ...
  return (
    <div className="w-full sticky top-0 z-40" style={{ backgroundColor }}>
      <div className="flex items-center justify-between pt-14 pb-12 px-32">
        ...
        <Link
          href="/"
          className="relative flex items-start gap-3 px-8 py-3 font-medium text-3xl transition-all duration-300 hover:scale-105 active:scale-95"
          style={{
